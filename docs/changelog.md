...
Each suite is its own page — click to expand.
...
> **Rule for future additions:** add new entries to the current suite's page (`changelog/suite-XX.md`).
> When a suite page grows beyond ~150 lines, split it and add a new row to the table above.
