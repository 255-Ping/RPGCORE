...
/**
 * Loads admin-defined crafting recipes from {@code plugins/rpg-crafting/recipes/*.yml} and
 * registers them with Bukkit.  The vanilla-suppression listener cancels vanilla crafting by
 * clearing any result whose recipe key namespace is "minecraft"; non-minecraft namespaces
 * (including "rpg-crafting") are allowed through unchanged.
 *
 * <p>Schema:
 * <pre>
 * super_diamond_sword:
...
public final class RecipeLoader {
    ...
    public void unregisterAll() {
        ...
        // Defensive sweep: remove any rpg-crafting recipes orphaned by a hot-reload.
    ...
    public int size() { return registeredKeys.size(); }
